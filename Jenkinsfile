    ...
    stage('x86_64-unknown-linux-gnu build') {
      ...
      steps {
        ...
        docker run --init --rm -v $(pwd):/workdir -w /workdir adlinktech/zenoh-dev-manylinux2010-x86_64-gnu \
            /bin/bash -c "\
            cargo build --release && \
            cargo deb -p zenoh_backend_filesystem \
            "
      ...
      steps {
        sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
          sh '''
            ...
            scp zenoh-backend-filesystem-${LABEL}-*macosx*.tgz genie.zenoh@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}/
          '''
        }
      }
    }
    ...
    stage('Publish zenoh-x86_64-unknown-linux-gnu to download.eclipse.org') {
      ...
      steps {
        sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
          sh '''
            ssh genie.zenoh@projects-storage.eclipse.org mkdir -p /home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}
            scp zenoh-backend-filesystem-${LABEL}-x86_64-unknown-linux-gnu.tgz target/x86_64-unknown-linux-gnu/debian/*.deb genie.zenoh@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}/
          '''
        }
      }
    }
    ...
    stage('Publish zenoh-i686-unknown-linux-gnu to download.eclipse.org') {
      ...
      steps {
        sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
          sh '''
            ssh genie.zenoh@projects-storage.eclipse.org mkdir -p /home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}
            scp zenoh-backend-filesystem-${LABEL}-i686-unknown-linux-gnu.tgz target/i686-unknown-linux-gnu/debian/*.deb genie.zenoh@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}/
          '''
        }
      }
    }
    ...
    stage('Publish zenoh-x86_64-pc-windows-gnu to download.eclipse.org') {
      ...
      steps {
        sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
          sh '''
            ssh genie.zenoh@projects-storage.eclipse.org mkdir -p /home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}
            scp zenoh-backend-filesystem-${LABEL}-x86_64-pc-windows-gnu.zip genie.zenoh@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}/
          '''
        }
      }
    }
    ...
    stage('Publish zenoh-i686-pc-windows-gnu to download.eclipse.org') {
      ...
      steps {
        sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
          sh '''
            ssh genie.zenoh@projects-storage.eclipse.org mkdir -p /home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}
            scp zenoh-backend-filesystem-${LABEL}-i686-pc-windows-gnu.zip genie.zenoh@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/zenoh/zenoh-backend-filesystem/${LABEL}/
          '''
        }
      }
    }
